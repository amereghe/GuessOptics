function CreateMeasFiles(savePath,eleName,Irange,Istep,magnetNames,LGENnames,TMcurrs,DGcurrMaxs,DGcurrMins,part,myCyCode,LGENfileList)
    ...
    if ( length(eleName)==1 )
        ...
        % combined elements scan (cartesian product)
